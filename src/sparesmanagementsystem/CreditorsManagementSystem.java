 ...
 * @author toshiba
 */
public class CreditorsManagementSystem extends JFrame{
   ...
   private String sss="Loading.";
    ...
    private static CreditorsManagementSystem frm;
    private JLayeredPane layeredPane = new JLayeredPane();
    private Color fontcolororg = new Color(255, 197, 110, 255);
    private Color fontcolorgray = new Color(124, 121, 118, 255);

    public CreditorsManagementSystem() {

        preloaderFrame = new JFrame("Creditors Management System");
        ...
        Icon bug = new ImageIcon(getClass().getResource("/Data/PosLogo.png"), "Loading...");
    ...
    public void loading()
    {
         ...
         for(int i=0;i<20;i++)
        {
            ...
            try {
                ...
                Logger.getLogger(CreditorsManagementSystem.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    ...
    {
         CreditorsManagementSystem preloaderFrame= new CreditorsManagementSystem();
